  ...
  <main class="max-w-5xl mx-auto mt-4 text-white">
    ...
    <section class="flex gap-x-10 flex-row items-center justify-between max-w-5xl mx-auto mt-40">
      <div class="w-11/12">
        ...
        <button class="bg-[#AF62AA] p-2 rounded-lg flex justify-end ml-auto bottom-0 mt-16 text-2xl font-bold">Welk dier past bij mij?</button>
      </div>
      <div class="w-10/12">
        <img src="../assets/headerImage.png" class="rounded-lg" alt="">
      </div>
    </section>
    <section class="flex gap-x-10 flex-row-reverse items-center justify-between max-w-5xl mx-auto mt-40">
      ...
      <div class="w-10/12">
        <div class="w-[400px] h-[400px] rounded-lg bg-gray-400"></div>
      </div>
    </section>
    <section class="flex gap-x-10 pb-32 flex-row-reverse items-center justify-center max-w-5xl mx-auto mt-40">
      ...
      <img src="../assets/flex-row-4.png" alt="">
    </section>
  </main>
